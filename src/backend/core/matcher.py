...
SYNONYMS: dict[str, str] = {
    ...
    # AI agents & modern tooling
    "mcp":                         "Artificial Intelligence Application",
    "mcp server":                  "Artificial Intelligence Application",
    "model context protocol":      "Artificial Intelligence Application",
    "ai agent":                    "Artificial Intelligence Application",
    "ai agents":                   "Artificial Intelligence Application",
    "agentic":                     "Artificial Intelligence Application",
    "claude":                      "Artificial Intelligence Application",
    "openai":                      "Artificial Intelligence Application",
    "gpt":                         "Artificial Intelligence Application",
    "gpt-4":                       "Artificial Intelligence Application",
    "chatgpt":                     "Artificial Intelligence Application",
    "prompt engineering":          "Artificial Intelligence Application",
    "vector embedding":            "Artificial Intelligence Application",
    "vector embeddings":           "Artificial Intelligence Application",
    "rag":                         "Artificial Intelligence Application",
    "retrieval augmented":         "Artificial Intelligence Application",
    "fine-tuning":                 "Artificial Intelligence Application",
    "data chunking":               "Data Engineering",
    # DevOps / CI/CD
    ...
    "api endpoint":                "Systems Integration",
    "api endpoints":               "Systems Integration",
    "endpoint schema":             "Systems Integration",
    "postman":                     "Systems Integration",
    "api testing":                 "Systems Integration",
    "webhook":                     "Systems Integration",
    # Security
    ...
    "erd":                         "Solution Architecture",
    "erd diagram":                 "Solution Architecture",
    "database design":             "Database Administration",
    # Cloud (extended)
    "digitalocean":                "Cloud Computing Implementation",
    "digital ocean":               "Cloud Computing Implementation",
    "cloud server":                "Cloud Computing Implementation",
    "cloud infrastructure":        "Cloud Computing Implementation",
    "cloud deployment":            "Cloud Computing Implementation",
    # Agile / PM
    ...
    # Customer / training
    "product demonstration":       "Customer Experience Management",
    "product demo":                "Customer Experience Management",
    "technical training":          "Customer Experience Management",
    "customer training":           "Customer Experience Management",
    "customer engineering":        "Customer Experience Management",
    "forward deployed":            "Customer Experience Management",
    # UX / Product
